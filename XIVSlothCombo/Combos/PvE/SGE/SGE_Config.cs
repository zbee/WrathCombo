    ...
    internal static partial class SGE
    {
        public static class Config
        {
            ...
            internal static void Draw(CustomComboPreset preset)
            {
                ...
                {
                    DrawHorizontalMultiChoice(SGE_ST_DPS_Movement, Toxikon.ActionName(), $"Use {Toxikon.ActionName()} when Addersting is available.", 4, 0);
                ...
                {
                    DrawSliderInt(0, 100, SGE_ST_Heal_Soteria, $"Use {Soteria.ActionName()} when Target HP is at or below set percentage");
                    DrawPriorityInput(SGE_ST_Heals_Priority, 7, 0, $"{Soteria.ActionName()} Priority: ");
                }

                if (preset is CustomComboPreset.SGE_ST_Heal_Zoe)
                {
                    DrawSliderInt(0, 100, SGE_ST_Heal_Zoe, $"Use {Zoe.ActionName()} when Target HP is at or below set percentage");
                    DrawPriorityInput(SGE_ST_Heals_Priority, 7, 1, $"{Zoe.ActionName()} Priority: ");
                }

                if (preset is CustomComboPreset.SGE_ST_Heal_Pepsis)
                {
                    DrawSliderInt(0, 100, SGE_ST_Heal_Pepsis, $"Use {Pepsis.ActionName()} when Target HP is at or below set percentage");
                ...
                {
                    DrawSliderInt(0, 100, SGE_ST_Heal_Taurochole, $"Use {Taurochole.ActionName()} when Target HP is at or below set percentage");
                ...
                {
                    DrawSliderInt(0, 100, SGE_ST_Heal_Haima, $"Use {Haima.ActionName()} when Target HP is at or below set percentage");
                    DrawPriorityInput(SGE_ST_Heals_Priority, 7, 4, $"{Haima.ActionName()} Priority: ");
                }

                if (preset is CustomComboPreset.SGE_ST_Heal_Krasis)
                {
                    DrawSliderInt(0, 100, SGE_ST_Heal_Krasis, $"Use {Krasis.ActionName()} when Target HP is at or below set percentage");
                ...
                {
                    DrawSliderInt(0, 100, SGE_ST_Heal_Druochole, $"Use {Druochole.ActionName()} when Target HP is at or below set percentage");
                ...
                {
                    DrawSliderInt(0, 100, SGE_ST_Heal_EDiagnosisHP, $"Use {EukrasianDiagnosis.ActionName()} when Target HP is at or below set percentage");
